      ...
      <div className='relative hidden h-full flex-col p-10 lg:flex dark:border-r'>
        ...
        <div className='text-sidebar-foreground relative z-20 mt-auto'>
          <blockquote className='space-y-2'>
            <p className='text-lg'>
              &ldquo;Управляйте каталогом, заказами и клиентами в одном рабочем пространстве.&rdquo;
            </p>
            <footer className='text-sidebar-foreground/70 text-sm'>Рабочее пространство MarketHub</footer>
          </blockquote>
        </div>
      </div>
