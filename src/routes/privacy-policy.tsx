...
export const Route = createFileRoute('/privacy-policy')({
  head: () => ({
    meta: seo({
      ...
      description:
        'Privacy policy for the MarketHub portfolio application — how the demo application handles data.',
      path: '/privacy-policy'
    })
  }),
  ...
  return (
    <div className='min-h-screen px-4 py-12 sm:px-6 lg:px-8'>
      <div className='mx-auto max-w-3xl space-y-8'>
        <h1 className='text-foreground text-3xl font-bold'>Политика конфиденциальности</h1>
        <section>
          <h2 className='text-foreground mb-3 text-xl font-semibold'>Введение</h2>
          <p className='text-muted-foreground text-base leading-relaxed'>
            This Политика конфиденциальности explains how we handle your personal information when you use our
        ...
        <section>
          <h2 className='text-foreground mb-3 text-xl font-semibold'>Сбор данных</h2>
          <p className='text-muted-foreground text-base leading-relaxed'>
        ...
        <section>
          <h2 className='text-foreground mb-3 text-xl font-semibold'>Демо-приложение</h2>
          <p className='text-muted-foreground text-base leading-relaxed'>
        ...
        <section>
          <h2 className='text-foreground mb-3 text-xl font-semibold'>Контакты</h2>
          <p className='text-muted-foreground text-base leading-relaxed'>
            If you have any questions, concerns, or requests regarding this Политика конфиденциальности or our
            data practices, please feel free to contact us at{' '}
            <a
              href='mailto:owner@markethub.dev'
        ...
        <div className='border-border border-t pt-4'>
          <p className='text-muted-foreground text-sm'>Обновлено: сентябрь 2026</p>
        </div>
      </div>
    </div>
  );
