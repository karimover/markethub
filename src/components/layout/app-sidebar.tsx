        ...
        <SidebarMenu>
          <SidebarMenuItem>
            <SidebarMenuButton size='lg' asChild>
              <Link to='/dashboard/overview' aria-label='MarketHub'>
                ...
                <div className='grid flex-1 text-left text-sm leading-tight'>
                  <span className='truncate font-semibold'>MarketHub</span>
                  <span className='text-muted-foreground truncate text-xs'>Рабочее пространство продавца</span>
                </div>
              </Link>
            </SidebarMenuButton>
          </SidebarMenuItem>
            ...
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                ...
                >
                  ...
                  <div className='grid flex-1 text-left text-sm leading-tight'>
                    <span className='truncate font-medium'>Emir Karimov</span>
                    <span className='text-muted-foreground truncate text-xs'>karimover06@gmail.com</span>
                  </div>
